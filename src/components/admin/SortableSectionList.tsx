    ...
    return (
        <div className="space-y-4">
            <SortableList lists={sections} orderChangeHandler={updateSectionOrder}>
                {(items, isPending) => items.map((section, index) => {
                    return (
                        <SortableItem 
                            key={section.id} 
                            id={section.id} 
                                    ...
                                    >
                                        ...
                                        >
                                            <div className="flex items-center gap-3">
                                                <ChevronDown className={cn("w-4 h-4 text-[#c9c8ab] transition-transform duration-200", isCollapsed && "-rotate-90")} />
                                                <div>
                                        ...
                                        {/* Section Lessons */}
                                        {!isCollapsed && <SortableLessonList section={section} />}
                                    </div>
                                );
                            })()}
                        </SortableItem>
